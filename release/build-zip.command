...
#   PLUGIN_ROOT=plugin PLUGIN_FILE=omega-cody.php SLUG=omega-cody release/build-zip.command
PLUGIN_ROOT="${PLUGIN_ROOT:-plugin}"
PLUGIN_ROOT="${PLUGIN_ROOT%/}"
PLUGIN_FILE="${PLUGIN_FILE:-omega-cody.php}"
SLUG="${SLUG:-omega-cody}"
DEFAULT_METADATA_URL="${DEFAULT_METADATA_URL:-https://omegabenefits.net/wp-update-server/?action=get_metadata&slug=omega-cody}"
